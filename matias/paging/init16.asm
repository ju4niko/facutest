;################################################################################
;#	Título: Modulo de iniciacion en 16 bits										#
;#																				#
;#	Versión:		2.0							Fecha: 	08-06-2017				#
;#	Autor: 			Matias Echavarria			Tab: 	4						#
;#	Compilación:	Usar Makefile												#
;#	Uso: 			-															#
;#	------------------------------------------------------------------------	#
;#	Descripción:	Inicializacion de PCI y perifericos basicos	para una PC		#
;#					Reemplaza el BIOS iniciando en 0xFFFFFFF0					#
;#	------------------------------------------------------------------------	#
;#	Revisiones:																	#
;#	------------------------------------------------------------------------	#
;#	TODO:																		#
...
%ifndef ROM_LOCATION							; Macro definida externamente
	%error "ROM_LOCATION no definido"
%endif	
...
font16x8:
	...
	db 0x00, 0x00, 0x10, 0x38, 0x6c, 0xc6, 0xc6, 0xfe, 0xc6, 0xc6, 0xc6, 0xc6, 0x00, 0x00, 0x00, 0x00 ;A
	;db 0x00, 0x00, 0x00, 0x00, 0xfe, 0xfe, 0xc6, 0xc6, 0xc6, 0xfe, 0xc6, 0xc6, 0xc6, 0xc7, 0x00, 0x00  ;A loca!
	
	db 0x00, 0x00, 0xfc, 0x66, 0x66, 0x66, 0x7c, 0x66, 0x66, 0x66, 0x66, 0xfc, 0x00, 0x00, 0x00, 0x00 ;B
	db 0x00, 0x00, 0x3c, 0x66, 0xc2, 0xc0, 0xc0, 0xc0, 0xc0, 0xc2, 0x66, 0x3c, 0x00, 0x00, 0x00, 0x00 ;C
	db 0x00, 0x00, 0xf8, 0x6c, 0x66, 0x66, 0x66, 0x66, 0x66, 0x66, 0x6c, 0xf8, 0x00, 0x00, 0x00, 0x00 ;D
	db 0x00, 0x00, 0xfe, 0x66, 0x62, 0x68, 0x78, 0x68, 0x60, 0x62, 0x66, 0xfe, 0x00, 0x00, 0x00, 0x00 ;E
...
ciclo_copia_fonts:
	...
	call	HabilitarA20 			;habilito el in A20 para extender la memoria disponible (init16.asm)
	;	xchg 	bx, bx						; Magic breakpoint

	lgdt 	[gdtr_img]				; GDTR provisoria para 16 bits
	
	smsw  	eax
	or	   	eax, CR0_PE				; Establecer el uP en MP
	lmsw  	ax
									; o32 jmp dowrd CS_SEL_32:flush_prefetch_queue
	db 		066h					; Prefijo
	db 		0EAh					; jmp
	dw 		flush_prefetch_queue	; offset parte baja
	dw 		ROM_LOCATION >> 16		; offset parte alta
	dw 		CS_SEL					; selector
...
;--------------------------------------------------------------------------------
; GDT provisoria para inicio en 16 bits. Queda dentro del binario init16.bin
;--------------------------------------------------------------------------------
ALIGN 4
GDT16:
NULL_SEL	equ		$-GDT16
...
flush_prefetch_queue:
	...
	mov		ds, ax
	mov		es, ax
									  ; Continua ejecutando en init32.asm
