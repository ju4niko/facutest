...
;	call cleansc
	...
	mov     al, 0xFD 					; Enmascaramos interrupciones del PIC N° 1 (menos teclado)
	out     0x21, al
	...
	lidt	[MI_idtr]						; Cargamos MI_idtr
	
	
	;HACER FUNCION LOCA PARA CARGAR EL OFFSET EN EL VECTOR DE INTERRUPCION
	xchg	bx, bx														;magic breakpoint
	xor edx,edx 						;edx=0
...
;+++++++++++++++++++++++++++++++++++++++++
;Activo las interrupciones para probarlas
...
;	pop eax
	...
	xchg	bx, bx														;magic breakpoint	
;*******************************************
;interrumpa cada 10ms el temporizador}
;  no se si funciona bien, no pude probarlo
;************************************
	call Timer_Config
...
;******************************************
	...
	int 32; activo la interrupcion para debug
